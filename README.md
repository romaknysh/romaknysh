...
```python
knysh = {
    "university": "UNIZA · FRI Informatika · 1st year",
    "location":   "Žilina, Slovakia",
    "focus":      "data analytics — sql, power bi, tableau, python",
    "also":       "broad dev background across many languages & stacks",
    "vibe":       "learning everything, breaking things, figuring it out"
}
```
...
```
power bi · tableau · sql   —  going deep, no speedrun
python for data            —  pandas, matplotlib, the whole thing
uniza fri                  —  1st year, informatika
...
[![GitHub](https://img.shields.io/badge/GitHub-0d1117?style=for-the-badge&logo=github&logoColor=ffffff)](https://github.com/romaknysh)
